    ...
    $.fn.suggestionBox = function (options) {
        ...
        function moveDown() {
            ...
            if (selectedLi === (listSize - 1)) {
                ...
                selectedLi++;
                select(selectedLi);
                $("#suggestion-box ul").scrollTop(0);
                $("#suggestion-box ul").scrollTop($('.selected:first').offset().top-$("#suggestion-box ul").height() - 39);
            }
        }
        ...
        function createSuggestionsList(data) {
            var $suggestions = '<ul id="suggestion-box-list">';
